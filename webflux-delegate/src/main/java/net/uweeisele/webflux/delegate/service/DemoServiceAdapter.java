package net.uweeisele.webflux.delegate.service;

import net.uweeisele.webflux.delegate.support.collections.Maps;
...
import static net.uweeisele.webflux.delegate.support.collections.Maps.entry;
